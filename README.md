...
When an NPC gets loaded for the first time, they roll for:

- Racial Powers (if the race has any)
- A Birthsign
- Birthsign Powers (if they successfully rolled a Birthsign with Powers)

Each roll is done only once for each NPC.
